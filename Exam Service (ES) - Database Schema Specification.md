...
- **TFQ**: chuỗi 4 ký tự biểu diễn 4 nhận định, ví dụ: `DSDN`
...
| `grade_id` | UUID / BIGINT / INT | Có | Mã khối/lớp mà câu hỏi thuộc về |
...
| `grade_id` | UUID / BIGINT / INT | Có | Khối/lớp mà đề áp dụng |
...
| `exam_uuid` | UUID | Có | Tham chiếu đến `EXAM.exam_uuid` |
| `grade_id` | UUID / BIGINT / INT | Có | Khối/lớp được giao đề |
